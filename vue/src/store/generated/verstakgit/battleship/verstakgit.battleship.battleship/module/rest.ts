 ...
 */
export interface BattleshipQueryParamsResponse {
  /** params holds all the parameters of this module. */
  params?: BattleshipParams;
}
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   *
   * @tags Query
   * @name QueryExistingGamesAll
   * @summary Queries a list of ExistingGames items.
   * @request GET:/verstakgit/battleship/battleship/existing_games
   */
  queryExistingGamesAll = (
    query?: {
    ...
    this.request<BattleshipQueryAllExistingGamesResponse, RpcStatus>({
      path: `/verstakgit/battleship/battleship/existing_games`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
   ...
   *
   * @tags Query
   * @name QueryExistingGames
   * @summary Queries a ExistingGames by index.
   * @request GET:/verstakgit/battleship/battleship/existing_games/{index}
   */
   ...
   * @request GET:/verstakgit/battleship/battleship/params
   */
  queryParams = (params: RequestParams = {}) =>
    this.request<BattleshipQueryParamsResponse, RpcStatus>({
      path: `/verstakgit/battleship/battleship/params`,
      method: "GET",
      format: "json",
      ...params,
    });
